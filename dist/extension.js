...
exports.response = exports.SidebarProvider = void 0;
const vscode = __webpack_require__(1);
const getNonce_1 = __webpack_require__(3);
const openaiResponse_1 = __webpack_require__(4);
let response;
...
class SidebarProvider {
    ...
    resolveWebviewView(webviewView) {
        ...
        webviewView.webview.onDidReceiveMessage(async (data) => {
            switch (data.type) {
                case "inputPrompt": {
                    if (!data.value.inputPrompt || !data.value.selectedModel) {
                        return;
                    }
                    exports.response = response = (0, openaiResponse_1.openAIResponse)(data.value.inputPrompt, data.value.selectedModel, data.value.temperature);
                    response.then((response_data) => {
                        console.log("Print in sidebarProvider.");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.openAIResponse = void 0;
// import * as dotenv from "dotenv";
const { Configuration, OpenAIApi } = __webpack_require__(5);
// dotenv.config();
const OPENAI_API_KEY = "Enter the API_KEY from OpenAI API";
const configuration = new Configuration({ apiKey: OPENAI_API_KEY });
const openai = new OpenAIApi(configuration);
async function openAIResponse(prompt, model, temperature) {
    try {
...
// @ts-ignore
const common_1 = __webpack_require__(56);
// @ts-ignore
const base_1 = __webpack_require__(57);
...
const packageJson = __webpack_require__(59);
class Configuration {
    constructor(param = {}) {
        ...
        if (!this.formDataCtor) {
            this.formDataCtor = __webpack_require__(60);
        }
    }
    /**
...
var CombinedStream = __webpack_require__(61);
...
var asynckit = __webpack_require__(68);
var populate = __webpack_require__(78);
...
module.exports =
{
  parallel      : __webpack_require__(69),
  serial        : __webpack_require__(76),
  serialOrdered : __webpack_require__(77)
};
...
var iterate    = __webpack_require__(70)
  , initState  = __webpack_require__(74)
  , terminator = __webpack_require__(75)
  ;
...
var defer = __webpack_require__(72);
...
var abort = __webpack_require__(73)
...
var serialOrdered = __webpack_require__(77);
